...
flowchart LR
    ...
    B -->|No| C[<a href='./dataset-ingestion.qmd'>Dataset Ingestion</a>]
    C --> E
    B -->|Yes| E{Do you have a story?}
    E -->|Yes| D[<a href='./discovery-configuration.qmd'> Discovery Configuration</a>]
    E -->|No| F[<a href='./dataset-configuration.qmd'> Dataset Configuration</a>]
```
