...
2. If using a local environment:
    ...
    1. Familiarize yourself with the [Setup](https://github.com/NASA-IMPACT/veda-ui/blob/main/docs/development/SETUP.md) and [Configuration](https://github.com/NASA-IMPACT/veda-ui/blob/main/docs/content/CONFIGURATION.md) sections of the documentation
