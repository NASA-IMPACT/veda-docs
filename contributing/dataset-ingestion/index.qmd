...
For a walk through of the full process outlined above, please refer to this [example notebook](example-template/example-geoglam-ingest.ipynb). This notebook uses the `GEOGLAM June 2023` dataset as an example, but please use this as a guide for the ingestion process (and required dataset defintions), replacing the GEOGLAM dataset with your own. 
