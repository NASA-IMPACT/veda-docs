...
Publishing a dataset to the VEDA catalog involves the following:

* uploading the files to a VEDA protected bucket (veda-data-store-staging)
* creating a stac collection for the dataset
* adding stac items for each file to the stac collection
