...
Guidance on recommended file formats (COG, Zarr, NetCDF4, GeoParquet), optimal file sizes, chunking strategies, and compression best practices.

### [Choosing the Right Data Format](decision-framework.qmd)
A decision framework to help select the appropriate format (COG, Zarr, NetCDF4, GeoParquet) based on data type, structure, and access patterns.
