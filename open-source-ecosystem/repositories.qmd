...
### [veda-auth-central](https://github.com/NASA-IMPACT/veda-auth-central)
...
Dashboard UI for viewing and analysing VEDA assets. Also the repository for the `@teamimpact/veda-ui` NPM package.
...
### [veda-architecture](https://github.com/NASA-IMPACT/veda-architecture) [team-internal]
