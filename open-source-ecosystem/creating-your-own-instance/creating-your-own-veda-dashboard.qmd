...
- That website and data could all be VEDA tools, so if you're starting from scratch, don't worry! Visit the [top-level instructions](/Users/anthonyboyd/Documents/Github/veda-docs/open-source-ecosystem/creating-your-own-instance/index.qmd) for using VEDA.
