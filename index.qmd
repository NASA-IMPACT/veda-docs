...
**Analyze:** Explore VEDA datasets and stories using a notebook environment. Follow the instructions on @veda-jh-access to gain access to the environment. If you are a scientist affiliated with NASA projects such as [EIS](https://eis.smce.nasa.gov/about.html) and [MAAP](https://ops.maap-project.org) you should have access to a notebook environment associated with those projects.
