...
The data ingestion process requires authenticating using `Keycloak` and an Identity Provider listed by [CILogon](https://www.cilogon.org/home), typically your work email. In order to set up authentication via Keycloak, see [Setting Up Keycloak](TODO). If you need assistance, you can contact a member of the VEDA Data Services Team at [veda@uah.edu](mailto:veda@uah.edu) who can set up permissions for you.
