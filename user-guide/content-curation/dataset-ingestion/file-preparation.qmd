...
VEDA supports inclusion of cloud optimized GeoTIFFs (COGs) to its data store through the [VEDA JupyterHub](https://docs.openveda.cloud/user-guide/scientific-computing/getting-access.html).
...
- Date + hour/minute/second: `TEMPO_NO2_L3_V03_2024-04-11T19:09:53Z.tif`, `TEMPO_NO2_L3_V03_20240411T19:09:53Z.tif`
...
Once you have the COGs, upload them to the `veda-data-store-staging` bucket.
