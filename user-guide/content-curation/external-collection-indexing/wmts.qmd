...
For reference, this [table](https://github.com/stac-extensions/web-map-links?tab=readme-ov-file#ogc-wmts) within the stac-extensions/web-map-links documentation details the required and optional fields for the WMTS extension to be STAC compliant.
