...
- Pre-rendered map tiles for dynamic visualization support
- Web Map Link extension support for STAC collection creation

[Learn more about ArcGIS Server Integration →](./wmts.qmd)
