...
Once a dataset is available in your VEDA STAC through VEDA Data Services (following the steps in the [Dataset Ingestion docs](https://docs.openveda.cloud/nasa-veda-platform/contributing/dataset-ingestion/)), you will need to configure the Dashboard.
...
3. If configuring through Github
    ...
    1. Create a new branch for the dataset overview
       ...
       Following the guidelines outlined in the [Content](https://github.com/NASA-IMPACT/veda-ui/blob/main/docs/content/CONTENT.md) section of the Github documentation, create your dataset overview mdx file
