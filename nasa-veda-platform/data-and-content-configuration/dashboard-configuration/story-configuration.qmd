...
subtitle: "Configuring up a story that references datasets in your Dashboard"
---
...
2. If using a local environment:
    ...
    3. Following the guidelines outlined in the [Content](https://github.com/NASA-IMPACT/veda-ui/blob/main/docs/content/CONTENT.md) section of the Github documentation, create your story mdx file
...
3. If configuring through Github
    ...
    1. Create a new branch for the story
       ...
       Following the guidelines outlined in the [Content](https://github.com/NASA-IMPACT/veda-ui/blob/main/docs/content/CONTENT.md) section of the Github documentation, create your story mdx file
