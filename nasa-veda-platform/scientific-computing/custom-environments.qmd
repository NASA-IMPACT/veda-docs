...
The VEDA JupyterHub lists a few *pre-built environments* (Docker images) as
**Server Options** intended to cover most users' needs.  However, since it is
impossible to cover every scenario, there are two options for choosing a *custom
environment*:
