...
Copy the `gh-scoped-creds.ipynb` notebook from the `shared-readwrite` directory to your personal home directory on the Hub.
...
1. Open the `gh-scoped-creds.ipynb` in your home directory.
2. Run the cell that contains `import gh_scoped_creds; %ghscopedcreds`.
