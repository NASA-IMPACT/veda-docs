...
- **Run this Notebook**: The section explains how to run the notebook locally, on [VEDA JupyterHub](https://hub.openveda.cloud/), on [VEDA Binder](https://binder.openveda.cloud/), or on the public [MyBinder](https://mybinder.org/). There are several examples of what this section can look like in the template notebooks.
