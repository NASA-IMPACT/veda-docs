...
See also [VEDA's goals for Scientific Computing](/veda-project/target-use-cases/scientific-computing.qmd).
...
Through the use of [open-source technology](/open-source-ecosystem/index.qmd), we make sure our services are interoperable and exchangeable.
...
This documentation site provides [Jupyter notebooks](/users-guide/notebooks/index.qmd) on how to load and analyze Earth data an interactive cloud computing environment.


## Getting access to VEDA's JupyterHub environment {#access}

Please see [Getting Access](getting-access.qmd).


## Screenshots

[![VEDA JupyterHub Screenshot](images/analytics-platform.png)](https://hub.openveda.cloud)