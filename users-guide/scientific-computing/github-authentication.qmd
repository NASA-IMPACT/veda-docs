...
Copy the `/home/jovyan/veda-docs/users-guide/notebooks/templates/template-github-auth.ipynb` notebook to your personal home directory on the Hub as `github-auth.ipynb`.
